...
public class propietario extends javax.swing.JFrame {
     ...
     */
    public propietario(cPropietario ctrlP) {
        this.ctrl = ctrlP;
        initComponents();
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(tel, javax.swing.GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)
                                        .addComponent(nom)
                                        .addComponent(dir)
                                        .addComponent(email)))
    ...
    private void guardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_guardarMouseClicked
        // TODO add your handling code here:
        if(!this.id.getText().isEmpty() && !this.nom.getText().isEmpty() && !this.dir.getText().isEmpty() && !this.tel.getText().isEmpty() && !this.email.getText().isEmpty()){
            if(this.ctrl.insert(nom.getText(), dir.getText(), Integer.parseInt(this.tel.getText()), email.getText(), Integer.parseInt(this.id.getText()))){
    ...
    private void ActualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ActualizarMouseClicked
        // TODO add your handling code here:
        if(!this.id.getText().isEmpty() && !this.nom.getText().isEmpty() && !this.dir.getText().isEmpty() && !this.tel.getText().isEmpty() && !this.email.getText().isEmpty()){
            if(this.ctrl.update(nom.getText(), dir.getText(), Integer.parseInt(this.tel.getText()), email.getText(), Integer.parseInt(this.id.getText()))){
                JOptionPane.showMessageDialog(null, "Datos registrados");
                this.clear();
            }else{
                JOptionPane.showMessageDialog(null, "No se registraron los datos");
    ...
    private void buscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buscarMouseClicked
        ...
        if(!this.id.getText().isEmpty() ){
            ...
            if(p != null){
                ...
                this.dir.setText(p.split(",")[2]);
                this.tel.setText(p.split(",")[3]);
                this.email.setText(p.split(",")[4]);
            }else{
